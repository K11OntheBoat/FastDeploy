...
class EPMegaRunner:
    ...
    def __init__(self, fd_config):
        ...
        print("===RyanDebug, the self.num_ranks is:", self.num_ranks) # 16
        print("===RyanDebug, the self.a_num_ranks is:", self.a_num_ranks) # 1
        print("===RyanDebug, the self.e_num_ranks is:", self.e_num_ranks) # 15
